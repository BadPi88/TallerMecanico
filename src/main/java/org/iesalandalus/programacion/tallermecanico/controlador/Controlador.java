        ...
        try {
            ...
            switch (evento) {
                ...
                case INSERTAR_MECANICO -> {
                    ...
                    resultado = "Trabajo de mecánico insertado correctamente.";
                }
                case INSERTAR_REVISION -> {
                    modelo.insertar(vista.leerRevision());
                    resultado = "Trabajo de revisión insertado correctamente.";
                }
                case INSERTAR_VEHICULO -> {
                    modelo.insertar(vista.leerVehiculo());
                    resultado = "Vehiculo insertado correctamente. ";
                }
                ...
                case LISTAR_TRABAJOS_CLIENTES -> vista.mostrarTrabajosCliente(modelo.getTrabajos(vista.leerClienteDni()));
            ...
            vista.notificarEvento(evento, e.getMessage(), false);
        }
    }
}